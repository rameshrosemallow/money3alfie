...
class _Home1State extends State<Home> {
  ...
  void _loadProfileDataFromSF() async {
    ...
    setState(() {
     ...
     String firstName1=map[ProfileKeys.REG_DATETIME.toString()];
     print(firstName1);
    ...
    try {
      if (response.statusCode == 200) {
       ...
       setState(() {
        ...
        map[ProfileKeys.REG_DATETIME.toString()] = registrationResponse.createdOn;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      appBar: AppBar(
        ...
        Center(child: Text(firstName??"",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16.sp),textAlign: TextAlign.center,),),
        SizedBox(width: 10.w,),
        Center(
          child:  CircleAvatar(
